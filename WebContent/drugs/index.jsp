...
<form action="index.jsp">
	...
	<c:forEach items="${drugs.rows}" var="row" varStatus="rowCounter">
		<option value="${row.drug}"	<c:if test="${rowCounter.first}">selected</c:if>>${row.drug}</option>
	</c:forEach>
	</select>
</form>
...
<div class="row">
	<div class="col-sm-12">
		<div class="panel panel-primary">
			...
			<div class="panel-footer" id="drug-panel-footer"><a href="feeds/drug.jsp?drug=Lopinavir">Export this list as JSON</a></div>
		</div>
	</div>
</div>
