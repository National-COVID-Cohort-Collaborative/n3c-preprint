...
<sql:query var="proteins" dataSource="jdbc/N3CCohort">
	...
	from (select
		  ...
		  from (select doi,title,name as section,full_text as sentence from covid_biorxiv.document natural join covid_biorxiv.section natural join covid_biorxiv.sentence natural join covid_biorxiv.pubchem_sentence_protein where phrase = ?) as foo
		  left outer join
