...
<sql:query var="drugs" dataSource="jdbc/N3CCohort">
	select month,coalesce(medrxiv,0) as medrxiv,coalesce(biorxiv,0) as biorxiv,coalesce(litcovid,0) as litcovid,coalesce(pmc,0) as pmc from covid_pubchem.genes_source_by_month where gene = ?
