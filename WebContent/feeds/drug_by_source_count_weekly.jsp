...
<sql:query var="drugs" dataSource="jdbc/N3CCohort">
	...
	from (
			...
			left outer join
			(select original||' ('||site||')' as symbol,to_char(pub_date,'yyyy-WW') as week,count(distinct doi)
			 from covid_biorxiv.biorxiv_current natural join covid_biorxiv.cohort_match
			 where original=? and pub_date > '2020-01-01' group by 1,2) as  bar
